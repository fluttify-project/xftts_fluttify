...
extension com_iflytek_speech_UtilityConfig_Batch on List<com_iflytek_speech_UtilityConfig> {
  ...
  Future<List<String>> getCallerInfo_batch(List<android_content_Context> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.UtilityConfig::getCallerInfo_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].refId, "var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<List<String>> getComponentUrlParam_batch(List<android_content_Context> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.UtilityConfig::getComponentUrlParam_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].refId, "refId": this[i].refId}]);
