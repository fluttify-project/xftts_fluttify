...
class com_iflytek_speech_UtilityConfig extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_speech_UtilityConfig>> create_batch__(int length) async {
    ...
    final List<com_iflytek_speech_UtilityConfig> typedResult = resultBatch.map((result) => com_iflytek_speech_UtilityConfig()..refId = result..tag = 'xftts_fluttify').toList();
...
extension com_iflytek_speech_UtilityConfig_Batch on List<com_iflytek_speech_UtilityConfig> {
  ...
  //region methods
  Future<List<String>> getCallerInfo_batch(List<android_content_Context> var0, List<String> var1) async {
    if (var0.length != var1.length) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.UtilityConfig::getCallerInfo_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__].refId, "var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<String>> getComponentUrlParam_batch(List<android_content_Context> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.UtilityConfig::getComponentUrlParam_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__].refId, "refId": this[__i__].refId}]);
