...
extension com_iflytek_speech_SpeechSynthesizerAidl_Batch on List<com_iflytek_speech_SpeechSynthesizerAidl> {
  ...
  Future<List<bool>> isSpeaking_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechSynthesizerAidl::isSpeaking_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<int>> setParameter_batch(List<String> var1, List<String> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechSynthesizerAidl::setParameter_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "var2": var2[i], "refId": this[i].refId}]);
  ...
  Future<List<String>> getParameter_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechSynthesizerAidl::getParameter_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<List<bool>> destory_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechSynthesizerAidl::destory_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
