...
extension com_iflytek_speech_SpeechUnderstanderAidl_Batch on List<com_iflytek_speech_SpeechUnderstanderAidl> {
  ...
  Future<List<bool>> isUnderstanding_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechUnderstanderAidl::isUnderstanding_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<int>> setParameter_batch(List<String> var1, List<String> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechUnderstanderAidl::setParameter_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "var2": var2[i], "refId": this[i].refId}]);
  ...
  Future<List<String>> getParameter_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechUnderstanderAidl::getParameter_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<List<int>> writeAudio_batch(List<Uint8List> var1, List<int> var2, List<int> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.speech.SpeechUnderstanderAidl::writeAudio_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "var2": var2[i], "var3": var3[i], "refId": this[i].refId}]);
