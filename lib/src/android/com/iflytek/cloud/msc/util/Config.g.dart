...
class com_iflytek_cloud_msc_util_Config extends java_lang_Object  {
  ...
  Future<void> putBean(String var1, Object var2) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.Config::putBean', {"var1": var1, "var2": var2, "refId": refId});
  ...
  Future<Object> getBean(String var1, String var2) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.Config::getBean', {"var1": var1, "var2": var2, "refId": refId});
...
extension com_iflytek_cloud_msc_util_Config_Batch on List<com_iflytek_cloud_msc_util_Config> {
  ...
  //region methods
  Future<List<com_iflytek_cloud_msc_util_Config>> getConfig_batch(List<android_content_Context> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.Config::getConfig_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__].refId, "refId": this[__i__].refId}]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_iflytek_cloud_msc_util_Config()..refId = result..tag = 'xftts_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  
  Future<void> putBoolean_batch(List<String> var1, List<bool> var2) async {
  ...
  Future<void> putLong_batch(List<String> var1, List<int> var2) async {
    if (var1.length != var2.length) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<void> putString_batch(List<String> var1, List<String> var2) async {
    if (var1.length != var2.length) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<void> putInt_batch(List<String> var1, List<int> var2) async {
    if (var1.length != var2.length) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<void> putBean_batch(List<String> var1, List<Object> var2) async {
    if (var1.length != var2.length) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<void> putLocation_batch(List<android_location_Location> var1) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<void> removeBean_batch(List<String> var1) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<bool>> hasGPSPermission_batch(List<android_content_Context> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.Config::hasGPSPermission_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__].refId, "refId": this[__i__].refId}]);
