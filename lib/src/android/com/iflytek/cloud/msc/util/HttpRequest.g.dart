...
class com_iflytek_cloud_msc_util_HttpRequest extends java_lang_Object  {
  ...
  Future<void> setRequest(String var1, String var2, Uint8List var3) async {
    // print log
    if (fluttifyLogEnabled) {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.HttpRequest::setRequest', {"var1": var1, "var2": var2, "var3": var3, "refId": refId});
