...
extension com_iflytek_cloud_msc_util_log_DebugLog_Batch on List<com_iflytek_cloud_msc_util_log_DebugLog> {
  ...
  Future<void> setTag_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::setTag_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> LogD__String__String_batch(List<String> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogD__String__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<void> LogD__String_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogD__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> LogI__String__String_batch(List<String> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogI__String__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<void> LogI__String_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogI__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> LogE__String_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogE__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> LogE__String__String_batch(List<String> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogE__String__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<void> LogS__String_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogS__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> LogS__String__String_batch(List<String> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogS__String__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<void> LogW__String__String_batch(List<String> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogW__String__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<void> LogW__String_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::LogW__String_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<List<bool>> getShowLog_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::getShowLog_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<void> setShowLog_batch(List<bool> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::setShowLog_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<List<com_iflytek_cloud_msc_util_log_DebugLog_LOG_LEVEL>> getLogLevel_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::getLogLevel_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<void> setLogLevel_batch(List<com_iflytek_cloud_msc_util_log_DebugLog_LOG_LEVEL> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::setLogLevel_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].index, "refId": this[i].refId}]);
  ...
  Future<void> updateJniLogStatus_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.msc.util.log.DebugLog::updateJniLogStatus_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
