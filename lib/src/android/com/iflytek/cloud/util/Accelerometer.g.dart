...
extension com_iflytek_cloud_util_Accelerometer_Batch on List<com_iflytek_cloud_util_Accelerometer> {
  ...
  Future<List<int>> getDirection_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.util.Accelerometer::getDirection_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
