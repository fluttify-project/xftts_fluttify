...
class com_iflytek_cloud_util_ResourceUtil extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_cloud_util_ResourceUtil>> create_batch__(int length) async {
    ...
    final List<com_iflytek_cloud_util_ResourceUtil> typedResult = resultBatch.map((result) => com_iflytek_cloud_util_ResourceUtil()..refId = result..tag = 'xftts_fluttify').toList();
...
extension com_iflytek_cloud_util_ResourceUtil_Batch on List<com_iflytek_cloud_util_ResourceUtil> {
  ...
  //region methods
  Future<List<String>> generateResourcePath_batch(List<android_content_Context> var0, List<com_iflytek_cloud_util_ResourceUtil_RESOURCE_TYPE> var1, List<String> var2) async {
