...
class com_iflytek_cloud_EvaluatorResult extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<List<com_iflytek_cloud_EvaluatorResult>> create_batch__String(List<String> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('ObjectFactory::create_batchcom_iflytek_cloud_EvaluatorResult__String', [for (int i = 0; i < var1.length; i++) {"var1": var1[i]}]);
...
extension com_iflytek_cloud_EvaluatorResult_Batch on List<com_iflytek_cloud_EvaluatorResult> {
  ...
  Future<List<String>> getResultString_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.EvaluatorResult::getResultString_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
