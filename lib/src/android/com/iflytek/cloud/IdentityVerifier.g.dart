...
extension com_iflytek_cloud_IdentityVerifier_Batch on List<com_iflytek_cloud_IdentityVerifier> {
  ...
  Future<List<com_iflytek_cloud_IdentityVerifier>> getVerifier_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.IdentityVerifier::getVerifier_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
