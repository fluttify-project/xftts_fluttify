...
extension com_iflytek_cloud_SpeechSynthesizer_Batch on List<com_iflytek_cloud_SpeechSynthesizer> {
  ...
  Future<List<com_iflytek_cloud_SpeechSynthesizer>> getSynthesizer_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.SpeechSynthesizer::getSynthesizer_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
