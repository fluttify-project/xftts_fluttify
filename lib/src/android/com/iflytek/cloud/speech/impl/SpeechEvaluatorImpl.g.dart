...
class com_iflytek_cloud_speech_impl_SpeechEvaluatorImpl extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_cloud_speech_impl_SpeechEvaluatorImpl>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('ObjectFactory::create_batchcom_iflytek_cloud_speech_impl_SpeechEvaluatorImpl__android_content_Context', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__].refId}]);
...
extension com_iflytek_cloud_speech_impl_SpeechEvaluatorImpl_Batch on List<com_iflytek_cloud_speech_impl_SpeechEvaluatorImpl> {
  ...
  Future<List<bool>> writeAudio_batch(List<Uint8List> var1, List<int> var2, List<int> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechEvaluatorImpl::writeAudio_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "var3": var3[__i__], "refId": this[__i__].refId}]);
  ...
  Future<void> stopEvaluating_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechEvaluatorImpl::stopEvaluating_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<void> cancel_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechEvaluatorImpl::cancel_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<bool>> isEvaluating_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechEvaluatorImpl::isEvaluating_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
