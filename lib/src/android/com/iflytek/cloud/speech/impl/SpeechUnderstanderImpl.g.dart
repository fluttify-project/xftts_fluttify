...
class com_iflytek_cloud_speech_impl_SpeechUnderstanderImpl extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_cloud_speech_impl_SpeechUnderstanderImpl>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('ObjectFactory::create_batchcom_iflytek_cloud_speech_impl_SpeechUnderstanderImpl__android_content_Context', [for (int i = 0; i < var1.length; i++) {"var1": var1[i].refId}]);
...
extension com_iflytek_cloud_speech_impl_SpeechUnderstanderImpl_Batch on List<com_iflytek_cloud_speech_impl_SpeechUnderstanderImpl> {
  ...
  Future<List<com_iflytek_cloud_speech_impl_SpeechUnderstanderImpl>> createUnderstander_batch(List<android_content_Context> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::createUnderstander_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].refId, "refId": this[i].refId}]);
  ...
  Future<List<com_iflytek_cloud_speech_impl_SpeechUnderstanderImpl>> getUnderstander_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::getUnderstander_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<bool>> isUnderstanding_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::isUnderstanding_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<int>> writeAudio_batch(List<Uint8List> var1, List<int> var2, List<int> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::writeAudio_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "var2": var2[i], "var3": var3[i], "refId": this[i].refId}]);
  ...
  Future<void> stopUnderstanding_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::stopUnderstanding_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<void> cancel_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::cancel_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<List<bool>> setParameter__String__String_batch(List<String> var1, List<String> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::setParameter__String__String_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "var2": var2[i], "refId": this[i].refId}]);
  ...
  Future<List<String>> getParameter_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::getParameter_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<List<bool>> destroy_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeechUnderstanderImpl::destroy_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
