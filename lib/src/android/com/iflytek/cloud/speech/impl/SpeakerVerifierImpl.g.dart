...
class com_iflytek_cloud_speech_impl_SpeakerVerifierImpl extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_cloud_speech_impl_SpeakerVerifierImpl>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('ObjectFactory::create_batchcom_iflytek_cloud_speech_impl_SpeakerVerifierImpl__android_content_Context', [for (int i = 0; i < var1.length; i++) {"var1": var1[i].refId}]);
...
extension com_iflytek_cloud_speech_impl_SpeakerVerifierImpl_Batch on List<com_iflytek_cloud_speech_impl_SpeakerVerifierImpl> {
  ...
  Future<void> stopListening_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::stopListening_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<String>> generatePassword_batch(List<int> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::generatePassword_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "refId": this[i].refId}]);
  ...
  Future<List<int>> writeAudio_batch(List<Uint8List> var1, List<int> var2, List<int> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::writeAudio_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i], "var2": var2[i], "var3": var3[i], "refId": this[i].refId}]);
  ...
  Future<List<bool>> isListening_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.SpeakerVerifierImpl::isListening_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
