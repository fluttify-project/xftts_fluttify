...
class com_iflytek_cloud_speech_impl_IdentityVerifierImpl extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_cloud_speech_impl_IdentityVerifierImpl>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('ObjectFactory::create_batchcom_iflytek_cloud_speech_impl_IdentityVerifierImpl__android_content_Context', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__].refId}]);
...
extension com_iflytek_cloud_speech_impl_IdentityVerifierImpl_Batch on List<com_iflytek_cloud_speech_impl_IdentityVerifierImpl> {
  ...
  Future<void> pushSessionInfo_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.IdentityVerifierImpl::pushSessionInfo_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<int>> writeData_batch(List<String> var1, List<String> var2, List<Uint8List> var3, List<int> var4, List<int> var5) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.IdentityVerifierImpl::writeData_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "var3": var3[__i__], "var4": var4[__i__], "var5": var5[__i__], "refId": this[__i__].refId}]);
  ...
  Future<void> stopWrite_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.IdentityVerifierImpl::stopWrite_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<void> cancel_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.IdentityVerifierImpl::cancel_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<bool>> isWorking_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.cloud.speech.impl.IdentityVerifierImpl::isWorking_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
