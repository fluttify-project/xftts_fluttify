...
class com_iflytek_cloud_DataUploader extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_cloud_DataUploader>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('ObjectFactory::create_batchcom_iflytek_cloud_DataUploader__android_content_Context', [for (int i = 0; i < var1.length; i++) {"var1": var1[i].refId}]);
