...
extension com_iflytek_msc_VAD_Batch on List<com_iflytek_msc_VAD> {
  ...
  Future<List<int>> Initialize_batch(List<int> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::Initialize_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> Uninitialize_batch(List<int> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::Uninitialize_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<void> Reset_batch(List<int> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::Reset_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<List<int>> AppendData_batch(List<int> var0, List<Uint8List> var2, List<int> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::AppendData_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i], "var3": var3[i], "refId": this[i].refId}]);
  ...
  Future<List<int>> SetParam_batch(List<int> var0, List<int> var2, List<int> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::SetParam_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i], "var3": var3[i], "refId": this[i].refId}]);
  ...
  Future<List<int>> EndAudioData_batch(List<int> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::EndAudioData_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "refId": this[i].refId}]);
  ...
  Future<List<int>> CalcVolumLevel_batch(List<int> var0, List<Uint8List> var2, List<int> var3, List<com_iflytek_msc_VAD_VadData> var4) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::CalcVolumLevel_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i], "var3": var3[i], "var4": var4[i].refId, "refId": this[i].refId}]);
  ...
  Future<List<int>> FetchData_batch(List<int> var0, List<com_iflytek_msc_VAD_VadData> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::FetchData_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i].refId, "refId": this[i].refId}]);
  ...
  Future<List<int>> GetLastSpeechPos_batch(List<int> var0, List<com_iflytek_msc_VAD_VadData> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::GetLastSpeechPos_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i].refId, "refId": this[i].refId}]);
