...
class com_iflytek_msc_VAD extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_msc_VAD>> create_batch__(int length) async {
    ...
    final List<com_iflytek_msc_VAD> typedResult = resultBatch.map((result) => com_iflytek_msc_VAD()..refId = result..tag = 'xftts_fluttify').toList();
...
extension com_iflytek_msc_VAD_Batch on List<com_iflytek_msc_VAD> {
  ...
  //region methods
  Future<List<int>> Initialize_batch(List<int> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::Initialize_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "refId": this[__i__].refId}]);
  ...
  Future<void> Uninitialize_batch(List<int> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::Uninitialize_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "refId": this[__i__].refId}]);
  ...
  Future<void> Reset_batch(List<int> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::Reset_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<int>> AppendData_batch(List<int> var0, List<Uint8List> var2, List<int> var3) async {
    if (var0.length != var2.length || var2.length != var3.length) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::AppendData_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "var2": var2[__i__], "var3": var3[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<int>> SetParam_batch(List<int> var0, List<int> var2, List<int> var3) async {
    if (var0.length != var2.length || var2.length != var3.length) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::SetParam_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "var2": var2[__i__], "var3": var3[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<int>> EndAudioData_batch(List<int> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::EndAudioData_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<int>> CalcVolumLevel_batch(List<int> var0, List<Uint8List> var2, List<int> var3, List<com_iflytek_msc_VAD_VadData> var4) async {
    if (var0.length != var2.length || var2.length != var3.length || var3.length != var4.length) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::CalcVolumLevel_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "var2": var2[__i__], "var3": var3[__i__], "var4": var4[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<int>> FetchData_batch(List<int> var0, List<com_iflytek_msc_VAD_VadData> var2) async {
    if (var0.length != var2.length) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::FetchData_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "var2": var2[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<int>> GetLastSpeechPos_batch(List<int> var0, List<com_iflytek_msc_VAD_VadData> var2) async {
    if (var0.length != var2.length) {
      return Future.error('all args must have same length!');
    }
  
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/xftts_fluttify').invokeMethod('com.iflytek.msc.VAD::GetLastSpeechPos_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var0": var0[__i__], "var2": var2[__i__].refId, "refId": this[__i__].refId}]);
