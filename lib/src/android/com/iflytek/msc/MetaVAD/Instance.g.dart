...
class com_iflytek_msc_MetaVAD_Instance extends java_lang_Object  {
  ...
  static Future<List<com_iflytek_msc_MetaVAD_Instance>> create_batch__(int length) async {
    ...
    final List<com_iflytek_msc_MetaVAD_Instance> typedResult = resultBatch.map((result) => com_iflytek_msc_MetaVAD_Instance()..refId = result..tag = 'xftts_fluttify').toList();
