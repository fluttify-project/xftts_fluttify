...
class IFlyResourceUtil extends NSObject  {
  ...
  static Future<List<IFlyResourceUtil>> create_batch__(int length) async {
    ...
    final List<IFlyResourceUtil> typedResult = resultBatch.map((result) => IFlyResourceUtil()..refId = result..tag = 'xftts_fluttify').toList();
...
extension IFlyResourceUtil_Batch on List<IFlyResourceUtil> {
  ...
  //region methods
  Future<List<String>> ENGINE_START_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> ENGINE_DESTROY_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> ASR_RES_PATH_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> GRM_BUILD_PATH_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> TTS_RES_PATH_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> IVW_RES_PATH_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> GRAMMARTYPE_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> PLUS_LOCAL_DEFAULT_RES_PATH_batch() async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> generateResourcePath_batch(List<String> path) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
  ...
  Future<List<String>> identifierForVoiceName_batch(List<String> voiceName) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
